        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <div class="btn btn-sm btn-primary" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Data Warna</a></div>
                </div>
                            ...
                            <table class="table table-bordered" id="mydata" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center;width:150px;">Kode Warna</th>
                                        <th style="text-align:center;width:150px;">Nama Kain</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <a class="btn btn-xs btn-primary" href="#modalEditPelanggan<?php echo $id ?>" data-toggle="modal" title="Edit"> Edit Warna</a>
